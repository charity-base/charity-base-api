...
const directiveResolvers = {
  isAuthenticated(next, source, args, context) {
    if (!context.apiKeyValue) {
      throw new GraphQLError(`You must supply an Authorization header of the form "Apikey my-api-key-example". See https://charitybase.uk/api-portal for more information.`)
    }
